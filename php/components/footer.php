        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-lg-6 mx-auto d-flex justify-content-center align-self-center align-items-lg-start text-center">
                <div class="my-auto">
                    ...
                    <p id="footer-special-name" class="footer-title d-inline-block px-4 fs-1">DLS Brothers</p>
                </div>
            </div>
            <!-- Description -->
            <div class="col-sm-12 col-lg-6 d-flex flex-column align-items-center align-items-lg-start text-center text-lg-start">
                ...
                Website developed by <a href="https://github.com/ganmatthew">Matthew Gan</a> and <a href="https://github.com/jerw18">Jeremy Wang</a><br>
