    ...
    <div class="article row px-auto mx-auto">
        ...
        <div class="card col-sm" style="width: 5rem;">
            ...
            <div class="card-body">
                ...
                <p class="card-text justify-content-center align-items-center text-center"></p>
        ...
        <div class="card col-sm" style="width: 5rem;">
            ...
            <div class="card-body">
                ...
                <p class="card-text justify-content-center align-items-center text-center"></p>
                <a href="https://thelasallian.com/2022/10/26/archiving-the-lasallian-mission-in-the-philippines/" class="card-link">Read More ></a>
            </div>
        </div>
    </div>
</div>